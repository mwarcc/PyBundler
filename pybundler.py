...
class PyBundler:
    def __init__(self, folder_path: str, main_file: str, logger: Optional[Logger] = None):
        ...
        self.import_analyzer = ImportAnalyzer(self.logger)
    ...
    def bundle(self, output_file: str):
        ...
        # Process files with parallel execution for better performance
        ...
        header = self._generate_bundle_header()
        
        # Add essential imports and bundled content
        content = [
            header,
            self.import_analyzer.get_formatted_imports(),
            bundled_content,
        ...
        # Update and display final statistics
    ...
    def _process_files_parallel(self, entry_point: str, executor) -> str:
        ...
        def process_single_file(file_path: str) -> Tuple[str, List[str]]:
            ...
            self.import_analyzer.analyze_imports(content)
...
"""
Generated by PyBundler
https://github.com/mwarcc/PyBundler/
